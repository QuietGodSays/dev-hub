...
describe("c-unit-test", () => {
    ...
    it("displays unit status with updated unitNumber", () => {
        ...
        // Return a promise to wait for any asynchronous DOM updates. Jest will automatically wait for the Promise
        // chain to complete before ending the test and fail the test if the promise rejects
